...
static const CGFloat CSToastDefaultDuration     = 2.4;
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        else if([point caseInsensitiveCompare:@"bottombar"] == NSOrderedSame) {
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGRect expectedRectTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName:titleLabel.font} context:nil];
    ...
    if (message != nil) {
        ...
        CGRect expectedRectMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName:messageLabel.font} context:nil];
